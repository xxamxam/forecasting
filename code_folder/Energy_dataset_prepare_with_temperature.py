...
X_train_norm = energy_scaler.fit_transform(X_train.reshape((train_size * emb_size, -1))  ).reshape((train_size, emb_size , -1))
X_test_norm = energy_scaler.transform(X_test.reshape((test_size * emb_size, -1))  ).reshape((test_size, emb_size , -1))
...
batch_size = 100
tr_dataloader = DataLoader(train_dataset, batch_size, drop_last=True, shuffle= False)
tst_dataloader = DataLoader(test_dataset, batch_size, drop_last=True, shuffle= False)